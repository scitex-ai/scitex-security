#!/usr/bin/env python3
# File: src/scitex_security/_runner.py

"""
Core security-audit orchestrator.

Discovers available tools and runs each requested checker, returning a
unified results dictionary. Absorbed from scitex-audit 0.2.0 as part
of the W1-reverse per ADR-0002 (scitex-dev #142).
"""
...
from ._github_runner import run_github_check
