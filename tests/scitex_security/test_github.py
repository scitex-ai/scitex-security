...
class TestGetSecretAlerts:
    ...
    @patch("scitex_security.github._run_gh_command")
...
class TestCheckGitHubAlerts:
    ...
    @patch("scitex_security.github.check_gh_auth")
    ...
    @patch("scitex_security.github.get_code_scanning_alerts")
    @patch("scitex_security.github.get_dependabot_alerts")
    @patch("scitex_security.github.get_secret_alerts")
    @patch("scitex_security.github.check_gh_auth")
